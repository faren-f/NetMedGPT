...
from src.model import TransformerModel, Classifier
import argparse
import time
...
parser.add_argument("--batch_size", required=False, default= 3, help= "provide batch size: it should be less than number of the provided heads")
